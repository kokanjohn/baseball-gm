...
function render() {
  ...
  container.innerHTML = _renderStep();
  _attachListeners();
}
...
function _renderDifficultyRow(label, ids, usedArchetypes) {
  ...
  return `
    <div class="arch-diff-group">
      <div class="arch-diff-label">${label}</div>
  ...
  return `
    <div class="arch-layout">
      ...
      <div class="arch-grid-wrap">
        ${_renderDifficultyRow('Easy',   ['institution', 'empire'],    usedArchetypes)}
        ${_renderDifficultyRow('Normal', ['contender',   'gambler'],   usedArchetypes)}
        ${_renderDifficultyRow('Hard',   ['lab',         'ember'],     usedArchetypes)}
      </div>
  ...
  return `
    <div class="intro-form">
      <div class="step-header">
        <div class="step-header-label">Step 2 of 4</div>
        <div class="step-header-title">Home Region</div>
        <div class="step-header-sub">Shapes your weather, travel, and ballpark character</div>
      </div>
...
function _renderNamingStep() {
  ...
  return `
    <div class="intro-form">
      <div class="step-header">
        <div class="step-header-label">Step 3 of 4</div>
        <div class="step-header-title">Name Your Team</div>
      </div>
      ...
      <div style="display:flex;gap:10px;margin-top:8px;">
        ...
        <button class="btn-primary" id="naming-next-btn" style="flex:1">CONTINUE</button>
      </div>
    </div>
  `;
}
...
function _renderColorsStep() {
  ...
  return `
    <div class="intro-form">
      <div class="step-header">
        <div class="step-header-label">Step 4 of 4</div>
        <div class="step-header-title">${_escape(_teamCity || 'Your City')} ${_escape(_teamNick || 'Team')}</div>
        <div class="step-header-sub">Choose your team colors</div>
      </div>
      ...
      <div style="display:flex;gap:10px;">
        ...
        <button class="btn-primary" id="start-btn" style="flex:1">TAKE THE JOB</button>
      </div>
    </div>
  `;
}
...
function _injectCSS() {
  ...
  style.textContent = `
    /* ── Archetype step: full-screen flex column ── */
    .arch-layout {
      display: flex;
    ...
    /* Grid wrapper — centers the 3 difficulty groups */
    .arch-grid-wrap {
      display: flex;
      flex-direction: column;
      gap: 10px;
    ...
    /* Difficulty group — border with inline label */
    .arch-diff-group {
      position: relative;
    ...
    /* Two cards side by side inside each group */
    .arch-row-cards {
      display: grid;
