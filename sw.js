...
const CACHE_VERSION = 'bgm-v309';
const ASSETS = [
  '/baseball-gm/Baseball_GM.html',
  '/baseball-gm/player-names.js',
  '/baseball-gm/cards-pool.js',
  '/baseball-gm/league.js',
  '/baseball-gm/manifest.json',
  '/baseball-gm/icon-192.png',
  '/baseball-gm/icon-512.png',
];

// HTML and SW itself are always fetched network-first so new versions land immediately
const NETWORK_FIRST = ['/baseball-gm/Baseball_GM.html', '/baseball-gm/sw.js'];
