...
export function tick() {
  ...
  // No plays generated yet (SimEngine Phase 6)
  ...
  StateManager.mutate(s => {
    ...
    // Update live score from play data
    if (nextPlay.ourScore  !== undefined) g.ourScore   = nextPlay.ourScore;
    if (nextPlay.theirScore !== undefined) g.theirScore = nextPlay.theirScore;
